...
from backend.scripts.supabase_client import get_supabase_client, linkedin_time_to_iso, using_supabase, utc_now_iso


def load_excluded_companies():
    path = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'backend', 'excluded_companies.json'))
